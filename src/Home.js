        ...
        <div classname="homeG">
          ...
          <div className="about1">
            ...
            <div className="about4">
              <p>I'm a computer programmer with an accounting background. </p>
              <p> I'm currently studying Software Engineering. </p>
              <p>
                I have delved into HTML, CSS, JAVASCRIPT, C PROGRAMMING AND
                PYTHON.
              </p>
              <p>
                I have also done and collaborated on a projects using REACT JS.
              </p>
              <p>
                I'm a believer that technology can change the future of the
                world if used rightly.
              </p>
              <p>
                I'm also passionate about coding because it gives me a sense of
                purpose that I will be able to build something worthwhile for
